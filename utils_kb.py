...
# top down map showing agent position and goal/target position
...
# top down map showing all positions of agent in the current episode and goal/target position
def get_map_with_path(env, map_res, agent_path):
     ...
     for k in range(len(agent_path)):
         ...
         tdm[agent_position_grid[0]-m1:agent_position_grid[0]+m1,agent_position_grid[1]-m1:agent_position_grid[1]+m1,:] = color 
     ...
     m2 = 3
     color = [0, 0, 255]
     tdm[target_position_grid[0]-m2:target_position_grid[0]+m2,target_position_grid[1]-m2:target_position_grid[1]+m2,:] = color
